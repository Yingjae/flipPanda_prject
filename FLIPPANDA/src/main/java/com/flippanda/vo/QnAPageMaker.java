...
public class QnAPageMaker {
	...
	// 현재 페에지, 페이지당 게시물 표시수 정보
	private QnACriteria qnacri;
	
	public QnAPageMaker(QnACriteria qnacri, int total) {
	...
	public String toString() {
		return "QnAPageMaker [startPage=" + startPage + ", endPage=" + endPage + ", prev=" + prev + ", next=" + next
				+ ", total=" + total + ", qnacri=" + qnacri + "]";
	}
